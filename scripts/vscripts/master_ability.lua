...
AtalantaAttribute = {
	...
	"atalanta_calydonian_snipe_attribute",
...
KarnaAttribute = {
	"karna_poor_attribute",
	"karna_ucm_attribute",
	"karna_mana_burst_attribute",
	"karna_divinity_attribute",
	"karna_indra_attribute",
	"karna_combo_vasavi",
	attrCount = 5
}
...
JTRAttribute = {
	"jtr_holy_mother_attribute",
	"jtr_mental_pollution_attribute",
	"jtr_surgical_procedure_attribute",
	"jtr_information_erase_attribute",
	"jtr_efficient_killer_attribute",
...
MordredAttribute = {
	"mordred_curse_attribute",
	"mordred_bc_attribute",
	"mordred_rampage_attribute",
	"mordred_pedigree_attribute",
...
function ResetMasterAbilities(hero)
	...
	masterUnit:FindAbilityByName("master_presence_resonator"):StartCooldown(0)
