...
function OnCaliburnHit(keys)
	...
	target:AddNewModifier(caster, target, "modifier_stunned", { Duration = 0.2 })
...
function OnExcaliburStart(keys)
	...
	giveUnitDataDrivenModifier(keys.caster, keys.caster, "pause_sealdisabled", 3.5)
...
function OnExcaliburHit(keys)
	...
	DoDamage(keys.caster, keys.target, keys.Damage * 0.1 , DAMAGE_TYPE_MAGICAL, 0, keys.ability, false)
end
...
function AvalonOnTakeDamage(keys)
	...
	if caster:IsAlive() and not caster:HasModifier("pause_sealdisabled") and not caster:HasModifier("modifier_max_excalibur") and caster.IsAvalonProc == true and caster:GetTeam() ~= attacker:GetTeam() and caster.IsAvalonOnCooldown ~= true and (caster:GetAbsOrigin() - attacker:GetAbsOrigin()):Length2D() < range then 
...
function StrikeAirPush(keys)
	...
	local totalDamage = base_damage 
	--if (target:GetName() == "npc_dota_hero_bounty_hunter" and target.IsPFWAcquired) then return end
	if caster.IsChivalryAcquired then
		totalDamage = base_damage + caster:FindAbilityByName("saber_invisible_air_upgrade"):GetLevel() * bonus_damage + keys.caster:FindAbilityByName("saber_caliburn_upgrade"):GetLevel() * bonus_damage
	else
		totalDamage = base_damage + caster:FindAbilityByName("saber_invisible_air"):GetLevel() * bonus_damage + keys.caster:FindAbilityByName("saber_caliburn"):GetLevel() * bonus_damage
	end
...
function SaberCheckCombo(caster, ability)
	if caster:GetStrength() >= 24.1 and caster:GetAgility() >= 24.1 and caster:GetIntellect() >= 24.1 then
		if caster.IsUtopiaAcquired and caster.IsExcaliburAcquired then
			if ability == caster:FindAbilityByName("saber_avalon_upgrade") and caster:FindAbilityByName("saber_excalibur_upgrade"):IsCooldownReady() and caster:FindAbilityByName("saber_max_excalibur_upgrade"):IsCooldownReady() and not caster:HasModifier("modifier_max_excalibur_cooldown") then
				ability:ApplyDataDrivenModifier(caster, caster, "modifier_max_excalibur_window", {})		
			end
		elseif caster.IsUtopiaAcquired and not caster.IsExcaliburAcquired then
			if ability == caster:FindAbilityByName("saber_avalon_upgrade") and caster:FindAbilityByName("saber_excalibur"):IsCooldownReady() and caster:FindAbilityByName("saber_max_excalibur"):IsCooldownReady() and not caster:HasModifier("modifier_max_excalibur_cooldown") then
				ability:ApplyDataDrivenModifier(caster, caster, "modifier_max_excalibur_window", {})		
			end
		elseif not caster.IsUtopiaAcquired and caster.IsExcaliburAcquired then
			if ability == caster:FindAbilityByName("saber_avalon") and caster:FindAbilityByName("saber_excalibur_upgrade"):IsCooldownReady() and caster:FindAbilityByName("saber_max_excalibur_upgrade"):IsCooldownReady() and not caster:HasModifier("modifier_max_excalibur_cooldown") then
				ability:ApplyDataDrivenModifier(caster, caster, "modifier_max_excalibur_window", {})		
			end
		elseif not caster.IsUtopiaAcquired and not caster.IsExcaliburAcquired then
			if ability == caster:FindAbilityByName("saber_avalon") and caster:FindAbilityByName("saber_excalibur"):IsCooldownReady() and caster:FindAbilityByName("saber_max_excalibur"):IsCooldownReady() and not caster:HasModifier("modifier_max_excalibur_cooldown") then
				ability:ApplyDataDrivenModifier(caster, caster, "modifier_max_excalibur_window", {})		
			end
		end
	end
...
function OnImproveExcaliburAcquired(keys)
	...
	hero:AddAbility("saber_excalibur_upgrade")
	hero:AddAbility("saber_max_excalibur_upgrade")
	if hero:HasModifier("modifier_max_excalibur_window") then 
		hero:RemoveModifierByName("modifier_max_excalibur_window")
	end
	hero:FindAbilityByName("saber_excalibur_upgrade"):SetLevel(hero:FindAbilityByName("saber_excalibur"):GetLevel())
	hero:FindAbilityByName("saber_max_excalibur_upgrade"):SetLevel(1)
	hero:SwapAbilities("saber_excalibur_upgrade", "saber_excalibur", true, false) 
	if not hero:FindAbilityByName("saber_excalibur"):IsCooldownReady() then 
		hero:FindAbilityByName("saber_excalibur_upgrade"):StartCooldown(hero:FindAbilityByName("saber_excalibur"):GetCooldownTimeRemaining())
	end
	if not hero:FindAbilityByName("saber_max_excalibur"):IsCooldownReady() then 
		hero:FindAbilityByName("saber_max_excalibur_upgrade"):StartCooldown(hero:FindAbilityByName("saber_max_excalibur"):GetCooldownTimeRemaining())
	end
	hero:RemoveAbility("saber_excalibur")
	hero:RemoveAbility("saber_max_excalibur")
...
function OnChivalryAcquired(keys)
	...
	hero:AddAbility("saber_invisible_air_upgrade")
	hero:AddAbility("saber_caliburn_upgrade")
	hero:FindAbilityByName("saber_invisible_air_upgrade"):SetLevel(hero:FindAbilityByName("saber_invisible_air"):GetLevel())
	hero:FindAbilityByName("saber_caliburn_upgrade"):SetLevel(hero:FindAbilityByName("saber_caliburn"):GetLevel())
	hero:SwapAbilities("saber_invisible_air_upgrade", "saber_invisible_air", true, false) 
	hero:SwapAbilities("saber_caliburn_upgrade", "saber_caliburn", true, false) 
	if not hero:FindAbilityByName("saber_caliburn"):IsCooldownReady() then 
		hero:FindAbilityByName("saber_caliburn_upgrade"):StartCooldown(hero:FindAbilityByName("saber_caliburn"):GetCooldownTimeRemaining())
	end
	if not hero:FindAbilityByName("saber_invisible_air"):IsCooldownReady() then 
		hero:FindAbilityByName("saber_invisible_air_upgrade"):StartCooldown(hero:FindAbilityByName("saber_invisible_air"):GetCooldownTimeRemaining())
	end
	hero:RemoveAbility("saber_invisible_air")
	hero:RemoveAbility("saber_caliburn")
...
function OnSAAvalonAcquired(keys)
	...
	hero:AddAbility("saber_avalon_upgrade")
	hero:FindAbilityByName("saber_avalon_upgrade"):SetLevel(hero:FindAbilityByName("saber_avalon"):GetLevel())
	hero:SwapAbilities("saber_avalon_upgrade", "saber_avalon", true, false) 
	if not hero:FindAbilityByName("saber_avalon"):IsCooldownReady() then 
		hero:FindAbilityByName("saber_avalon_upgrade"):StartCooldown(hero:FindAbilityByName("saber_avalon"):GetCooldownTimeRemaining())
	end
	hero:RemoveAbility("saber_avalon")
